...
const getUnfundedGamesCount = () =>
  GAMES_JSON.filter((game) => game.pledged < game.goal).length;
const totalUnfundedGames = getUnfundedGamesCount();
...
Currently, ${totalUnfundedGames} ${
  totalUnfundedGames > 1 ? "games remain unfunded." : "game remains unfunded."
} 
...
const topPledgeGameName = document.createElement("p");
topPledgeGameName.innerHTML = firstGame.name;
firstGameContainer.appendChild(topPledgeGameName);
